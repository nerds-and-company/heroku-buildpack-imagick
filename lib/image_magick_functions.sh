function install_image_magick() {
  ...
  export LD_LIBRARY_PATH=$IMAGE_MAGICK_INSTALL_DIR/lib:$LD_LIBRARY_PATH
  export PKG_CONFIG_PATH=$IMAGE_MAGICK_INSTALL_DIR/lib/pkgconfig:$PKG_CONFIG_PATH
  export CPPFLAGS="-I$IMAGE_MAGICK_INSTALL_DIR/include $CPPFLAGS"
}
